...
class ShiftBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, kernel_size=1, padding=0):
        ...
        self.binary_conv = nn.Conv2d(inplanes, planes, stride=stride, kernel_size=kernel_size, padding=padding, bias=False)
        self.binary_conv1 = nn.Conv2d(inplanes, planes, stride=stride, kernel_size=kernel_size, padding=padding, bias=False)
        self.binary_conv2 = nn.Conv2d(inplanes, planes, stride=stride, kernel_size=kernel_size, padding=padding, bias=False)
